...
pub use macho::segment::{
    LC_SEGMENT_64, S_ATTR_PURE_INSTRUCTIONS, S_ATTR_SOME_INSTRUCTIONS, S_CSTRING_LITERALS,
    S_GB_ZEROFILL, S_LAZY_SYMBOL_POINTERS, S_NON_LAZY_SYMBOL_POINTERS, S_REGULAR, S_SYMBOL_STUBS,
    S_THREAD_LOCAL_REGULAR, S_THREAD_LOCAL_VARIABLES, S_THREAD_LOCAL_ZEROFILL, S_ZEROFILL,
    SECTION_64_SIZE, SECTION_TYPE, SEGMENT_COMMAND_64_SIZE, Section64, SegmentCommand64,
    VM_PROT_EXECUTE, VM_PROT_READ, VM_PROT_RWX, VM_PROT_WRITE,
};
