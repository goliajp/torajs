...
pub use macho::segment::{
    LC_SEGMENT_64, S_ATTR_PURE_INSTRUCTIONS, S_ATTR_SOME_INSTRUCTIONS, S_LAZY_SYMBOL_POINTERS,
    S_NON_LAZY_SYMBOL_POINTERS, S_SYMBOL_STUBS, SECTION_64_SIZE, SEGMENT_COMMAND_64_SIZE,
    Section64, SegmentCommand64, VM_PROT_EXECUTE, VM_PROT_READ, VM_PROT_RWX, VM_PROT_WRITE,
};
