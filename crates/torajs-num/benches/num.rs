...
fn bench_sqrt_hot_loop(c: &mut Bench) {
...
fn bench_pow_hot_loop(c: &mut Bench) {
...
fn bench_parse_int(c: &mut Bench) {
...
fn bench_parse_float(c: &mut Bench) {
