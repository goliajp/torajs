...
pub mod color;
pub use any_method::{
    ANY_METHOD_ADD, ANY_METHOD_CHAR_AT, ANY_METHOD_CLEAR, ANY_METHOD_DELETE, ANY_METHOD_ENDS_WITH,
    ANY_METHOD_ENTRIES, ANY_METHOD_EXEC, ANY_METHOD_FILTER, ANY_METHOD_FOR_EACH, ANY_METHOD_GET,
    ...
    ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH, ANY_METHOD_TEST,
