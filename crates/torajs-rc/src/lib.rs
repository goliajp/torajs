...
pub use any_method::{
    ...
    ANY_METHOD_STRIKE, ANY_METHOD_SUB, ANY_METHOD_SUP, ANY_METHOD_TEST, ANY_METHOD_TO_DATE_STRING,
    ...
    ANY_METHOD_TO_LOCALE_STRING, ANY_METHOD_TO_LOCALE_TIME_STRING, ANY_METHOD_TO_LOWER_CASE,
