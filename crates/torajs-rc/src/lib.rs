...
pub use any_method::{
    ...
    ANY_METHOD_SLICE, ANY_METHOD_SMALL, ANY_METHOD_SOME, ANY_METHOD_SORT, ANY_METHOD_SPLICE,
    ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH, ANY_METHOD_STR_ITERATOR, ANY_METHOD_STRIKE,
    ANY_METHOD_SUB, ANY_METHOD_SUBARRAY, ANY_METHOD_SUBSTR, ANY_METHOD_SUBSTRING, ANY_METHOD_SUP,
    ...
    ANY_METHOD_TO_STRING, ANY_METHOD_TO_UPPER_CASE, ANY_METHOD_TO_WELL_FORMED, ANY_METHOD_TRIM,
