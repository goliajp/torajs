...
pub use any_method::{
    ...
    ANY_METHOD_COPY_WITHIN, ANY_METHOD_DELETE, ANY_METHOD_DIFFERENCE, ANY_METHOD_ENDS_WITH,
    ANY_METHOD_ENTRIES, ANY_METHOD_EVERY, ANY_METHOD_EXEC, ANY_METHOD_FILL, ANY_METHOD_FILTER,
    ANY_METHOD_FIND, ANY_METHOD_FIND_INDEX, ANY_METHOD_FIND_LAST, ANY_METHOD_FIND_LAST_INDEX,
    ANY_METHOD_FIXED, ANY_METHOD_FLAT, ANY_METHOD_FLAT_MAP, ANY_METHOD_FONTCOLOR,
    ANY_METHOD_FONTSIZE, ANY_METHOD_FOR_EACH, ANY_METHOD_GET, ANY_METHOD_GET_DATE,
    ANY_METHOD_GET_DAY, ANY_METHOD_GET_FULL_YEAR, ANY_METHOD_GET_HOURS,
    ...
    ANY_METHOD_LINK, ANY_METHOD_LOCALE_COMPARE, ANY_METHOD_MAP, ANY_METHOD_MATCH,
    ...
    ANY_METHOD_PUSH, ANY_METHOD_REDUCE, ANY_METHOD_REDUCE_RIGHT, ANY_METHOD_REPEAT,
    ANY_METHOD_REPLACE, ANY_METHOD_REPLACE_ALL, ANY_METHOD_REVERSE, ANY_METHOD_SEARCH,
    ANY_METHOD_SET, ANY_METHOD_SET_DATE, ANY_METHOD_SET_FULL_YEAR, ANY_METHOD_SET_HOURS,
