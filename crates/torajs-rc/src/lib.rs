...
pub use any_method::{
    ...
    ANY_METHOD_NEXT, ANY_METHOD_POP, ANY_METHOD_PUSH, ANY_METHOD_SET, ANY_METHOD_SET_DATE,
    ...
    ANY_METHOD_SET_YEAR, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SPLIT, ANY_METHOD_TEST,
