...
pub mod color;
pub use any_method::{
    ANY_METHOD_ADD, ANY_METHOD_CHAR_AT, ANY_METHOD_CLEAR, ANY_METHOD_DELETE, ANY_METHOD_EXEC,
    ...
    ANY_METHOD_PUSH, ANY_METHOD_SET, ANY_METHOD_SET_DATE, ANY_METHOD_SET_FULL_YEAR,
    ...
    ANY_METHOD_VALUE_OF, ANY_RPROP_DOT_ALL, ANY_RPROP_FLAGS, ANY_RPROP_GLOBAL,
    ANY_RPROP_IGNORE_CASE, ANY_RPROP_LAST_INDEX, ANY_RPROP_MULTILINE, ANY_RPROP_SOURCE,
    ANY_RPROP_STICKY, ANY_RPROP_UNICODE, any_method_id, any_regexp_prop_id,
};
pub use arr_kind::{
