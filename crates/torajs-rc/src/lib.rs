...
pub use any_method::{
    ...
    ANY_METHOD_REVERSE, ANY_METHOD_SEARCH, ANY_METHOD_SET, ANY_METHOD_SET_FROM_BASE64,
    ANY_METHOD_SET_FROM_HEX, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SMALL, ANY_METHOD_SOME,
    ANY_METHOD_SORT, ANY_METHOD_SPLICE, ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH,
    ANY_METHOD_STR_ITERATOR, ANY_METHOD_STRIKE, ANY_METHOD_SUB, ANY_METHOD_SUBARRAY,
    ...
    ANY_METHOD_THROW_TYPE_ERROR, ANY_METHOD_TO_BASE64, ANY_METHOD_TO_EXPONENTIAL,
    ANY_METHOD_TO_FIXED, ANY_METHOD_TO_HEX, ANY_METHOD_TO_JSON, ANY_METHOD_TO_LOCALE_LOWER_CASE,
