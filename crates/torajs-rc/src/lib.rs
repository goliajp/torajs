...
pub use any_method::{
    ...
    ANY_METHOD_FILTER, ANY_METHOD_FIND, ANY_METHOD_FIND_INDEX, ANY_METHOD_FIND_LAST,
    ANY_METHOD_FIND_LAST_INDEX, ANY_METHOD_FIXED, ANY_METHOD_FLAT, ANY_METHOD_FLAT_MAP,
    ANY_METHOD_FONTCOLOR, ANY_METHOD_FONTSIZE, ANY_METHOD_FOR_EACH, ANY_METHOD_GET,
    ...
    ANY_METHOD_GET_SECONDS, ANY_METHOD_GET_SIZE, ANY_METHOD_GET_TIME,
