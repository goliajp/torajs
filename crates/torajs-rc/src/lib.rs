...
pub mod color;
pub use any_method::{
    ANY_METHOD_ADD, ANY_METHOD_CHAR_AT, ANY_METHOD_CLEAR, ANY_METHOD_DELETE, ANY_METHOD_ENTRIES,
    ANY_METHOD_EXEC, ANY_METHOD_FILTER, ANY_METHOD_FOR_EACH, ANY_METHOD_GET, ANY_METHOD_GET_DATE,
    ...
    ANY_METHOD_INCLUDES, ANY_METHOD_INDEX_OF, ANY_METHOD_JOIN, ANY_METHOD_KEYS, ANY_METHOD_MAP,
    ANY_METHOD_MATCH, ANY_METHOD_NEXT, ANY_METHOD_POP, ANY_METHOD_PUSH, ANY_METHOD_REPLACE,
    ANY_METHOD_REPLACE_ALL, ANY_METHOD_SET, ANY_METHOD_SET_DATE, ANY_METHOD_SET_FULL_YEAR,
    ...
    ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SPLIT, ANY_METHOD_TEST,
