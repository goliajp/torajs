...
pub use flags::{
    ...
    FLAG_CLASS_METHOD_THIS_FREE, FLAG_CLOSURE_RECV_FIRST, FLAG_DYNOBJ_CLASS_CTOR, FLAG_ERROR,
    FLAG_FN_ASYNC, FLAG_FN_GENERATOR, FLAG_FN_LENGTH_DELETED, FLAG_FN_NAME_DELETED, FLAG_FN_PROTO,
    FLAG_FROZEN, FLAG_NON_EXTENSIBLE, FLAG_SEALED, FLAG_SPLIT_BLOCK, FLAG_STATIC_LITERAL,
};
pub use ns_static::{
