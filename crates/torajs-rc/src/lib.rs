...
pub use any_method::{
    ...
    ANY_METHOD_CHAR_CODE_AT, ANY_METHOD_CLEAR, ANY_METHOD_CONCAT, ANY_METHOD_COPY_WITHIN,
    ANY_METHOD_DELETE, ANY_METHOD_ENDS_WITH, ANY_METHOD_ENTRIES, ANY_METHOD_EVERY, ANY_METHOD_EXEC,
    ANY_METHOD_FILL, ANY_METHOD_FILTER, ANY_METHOD_FIND, ANY_METHOD_FIND_INDEX, ANY_METHOD_FIXED,
    ...
    ANY_METHOD_STARTS_WITH, ANY_METHOD_STRIKE, ANY_METHOD_SUB, ANY_METHOD_SUBSTR,
    ANY_METHOD_SUBSTRING, ANY_METHOD_SUP, ANY_METHOD_TEST, ANY_METHOD_TO_DATE_STRING,
