...
/* __torajs_map_iter_next (forEach helper) moved to
 * torajs-collections::iter (P4.3-f, 2026-05-24). */

/* MapIter family (struct + 4 create variants + step + drop + the
 * map_iter_make_pair_arr static helper) all moved to
 * torajs-collections::iter (P4.3-f, 2026-05-24). Tag 16
 * (TAG_MAP_ITER) + kind constants now live in torajs-collections::iter
 * module too. Cross-tier symbol resolution at `tr build` link time. */
