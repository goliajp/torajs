...
// ============================================================
// Line-width estimate (inspect wrap trunk) — mirror of bun
// 1.3.14's Formatter.estimated_line_length
// (ConsoleObject.zig:1028-1042). The estimate is deliberately
// approximate the same way bun's is: string quotes and ANSI
// codes are NOT counted, commas / separator spaces / digits /
// literal keyword widths ARE. Wrap decisions compare
// `estimate > 80` (strictly greater) after each comma.
//
// Multi-thread-ready shape (design-principles §6.2): a process-
// wide atomic, not `static mut` / lock. Concurrent console.log
// already interleaves at the byte level; when stdout gains its
// per-thread serialization this estimate joins that same lock
// domain.
// ============================================================
