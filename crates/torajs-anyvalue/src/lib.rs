...
pub(crate) mod method_call_bag_expando;
...
mod method_call_object_proto_own;
mod method_call_object_proto_tag;
mod method_call_prelude;
...
mod tests {
    ...
    #[unsafe(no_mangle)]
    pub unsafe extern "C" fn __torajs_proto_tostringtag_install(_proto: *mut c_void, _idx: i64) {}
    ...
    link_stub!(
        ...
        __torajs_typedarray_buffer,
        __torajs_typedarray_bytes_per_element,
        __torajs_typedarray_kind,
        ...
        __torajs_typedarray_index_of,
        __torajs_typedarray_last_index_of,
        __torajs_typedarray_includes,
        __torajs_typedarray_subarray,
        ...
        __torajs_str_any_replace_regex_fn,
