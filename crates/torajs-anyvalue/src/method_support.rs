...
use torajs_rc::{
    ...
    ANY_METHOD_FILTER, ANY_METHOD_FOR_EACH, ANY_METHOD_GET, ANY_METHOD_HAS,
    ...
    ANY_METHOD_REVERSE, ANY_METHOD_SET, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SPLIT,
    ANY_METHOD_STARTS_WITH, ANY_METHOD_TEST, ANY_METHOD_TO_EXPONENTIAL, ANY_METHOD_TO_FIXED,
