...
use torajs_rc::{
    ...
    ANY_METHOD_IS_WELL_FORMED, ANY_METHOD_JOIN, ANY_METHOD_KEYS, ANY_METHOD_LAST_INDEX_OF,
    ANY_METHOD_LOCALE_COMPARE, ANY_METHOD_MAP, ANY_METHOD_MATCH, ANY_METHOD_MATCH_ALL,
    ANY_METHOD_NORMALIZE, ANY_METHOD_PAD_END, ANY_METHOD_PAD_START, ANY_METHOD_POP,
    ...
    ANY_METHOD_SEARCH, ANY_METHOD_SET, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SOME,
