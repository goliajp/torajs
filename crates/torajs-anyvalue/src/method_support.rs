...
use torajs_rc::{
    ...
    ANY_METHOD_SUBSTR, ANY_METHOD_SUBSTRING, ANY_METHOD_SUP, ANY_METHOD_SYMMETRIC_DIFFERENCE,
    ANY_METHOD_TEST, ANY_METHOD_TO_EXPONENTIAL, ANY_METHOD_TO_FIXED,
    ...
    ANY_METHOD_UNION, ANY_METHOD_UNSHIFT, ANY_METHOD_VALUE_OF, ANY_METHOD_VALUES, ANY_METHOD_WITH,
};
