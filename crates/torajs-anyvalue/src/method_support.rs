...
use torajs_rc::{
    ...
    ANY_METHOD_JOIN, ANY_METHOD_KEYS, ANY_METHOD_LAST_INDEX_OF, ANY_METHOD_LOCALE_COMPARE,
    ANY_METHOD_MAP, ANY_METHOD_MATCH, ANY_METHOD_PAD_END, ANY_METHOD_PAD_START, ANY_METHOD_POP,
    ...
    ANY_METHOD_SET, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SOME, ANY_METHOD_SORT,
    ANY_METHOD_SPLICE, ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH, ANY_METHOD_SUBSTR,
    ANY_METHOD_SUBSTRING, ANY_METHOD_SUP, ANY_METHOD_TEST, ANY_METHOD_TO_EXPONENTIAL,
