...
use torajs_rc::{
    ...
    ANY_METHOD_RESIZE, ANY_METHOD_REVERSE, ANY_METHOD_SEARCH, ANY_METHOD_SET,
    ANY_METHOD_SET_FROM_BASE64, ANY_METHOD_SET_FROM_HEX, ANY_METHOD_SHIFT, ANY_METHOD_SLICE,
    ...
    ANY_METHOD_SYMMETRIC_DIFFERENCE, ANY_METHOD_TEST, ANY_METHOD_TO_BASE64,
    ANY_METHOD_TO_EXPONENTIAL, ANY_METHOD_TO_FIXED, ANY_METHOD_TO_HEX,
    ANY_METHOD_TO_LOCALE_LOWER_CASE, ANY_METHOD_TO_LOCALE_STRING, ANY_METHOD_TO_LOCALE_UPPER_CASE,
    ANY_METHOD_TO_LOWER_CASE, ANY_METHOD_TO_PRECISION, ANY_METHOD_TO_REVERSED,
    ANY_METHOD_TO_SORTED, ANY_METHOD_TO_SPLICED, ANY_METHOD_TO_STRING, ANY_METHOD_TO_UPPER_CASE,
    ANY_METHOD_TO_WELL_FORMED, ANY_METHOD_TRANSFER, ANY_METHOD_TRANSFER_TO_FIXED_LENGTH,
    ANY_METHOD_TRIM, ANY_METHOD_TRIM_END, ANY_METHOD_TRIM_START, ANY_METHOD_UNION,
    ANY_METHOD_UNSHIFT, ANY_METHOD_VALUE_OF, ANY_METHOD_VALUES, ANY_METHOD_WITH,
};
