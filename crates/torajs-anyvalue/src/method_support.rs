...
use torajs_rc::{
    ...
    ANY_METHOD_MAP, ANY_METHOD_MATCH, ANY_METHOD_MATCH_ALL, ANY_METHOD_NORMALIZE,
    ...
    ANY_METHOD_TO_STRING, ANY_METHOD_TO_UPPER_CASE, ANY_METHOD_TRIM, ANY_METHOD_TRIM_END,
