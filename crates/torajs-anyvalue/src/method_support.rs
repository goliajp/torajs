...
use torajs_rc::{
    ...
    ANY_METHOD_IS_SUPERSET_OF, ANY_METHOD_IS_WELL_FORMED, ANY_METHOD_JOIN, ANY_METHOD_KEYS,
    ...
    ANY_METHOD_POP, ANY_METHOD_PUSH, ANY_METHOD_REDUCE, ANY_METHOD_REDUCE_RIGHT, ANY_METHOD_REPEAT,
    ...
    ANY_METHOD_SUBSTRING, ANY_METHOD_SUP, ANY_METHOD_SYMMETRIC_DIFFERENCE, ANY_METHOD_TEST,
    ...
    ANY_METHOD_TRIM_END, ANY_METHOD_TRIM_START, ANY_METHOD_UNION, ANY_METHOD_UNSHIFT,
