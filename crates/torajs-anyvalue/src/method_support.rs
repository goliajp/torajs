...
use torajs_rc::{
    ...
    ANY_METHOD_FIND_LAST_INDEX, ANY_METHOD_FLAT, ANY_METHOD_FLAT_MAP, ANY_METHOD_FOR_EACH,
    ANY_METHOD_GET, ANY_METHOD_HAS, ANY_METHOD_HAS_OWN_PROPERTY, ANY_METHOD_INCLUDES,
    ANY_METHOD_INDEX_OF, ANY_METHOD_IS_WELL_FORMED, ANY_METHOD_JOIN, ANY_METHOD_KEYS,
    ANY_METHOD_LAST_INDEX_OF, ANY_METHOD_LOCALE_COMPARE, ANY_METHOD_MAP, ANY_METHOD_MATCH,
    ANY_METHOD_MATCH_ALL, ANY_METHOD_NORMALIZE, ANY_METHOD_PAD_END, ANY_METHOD_PAD_START,
    ...
    ANY_METHOD_SOME, ANY_METHOD_SORT, ANY_METHOD_SPLICE, ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH,
    ANY_METHOD_SUBSTR, ANY_METHOD_SUBSTRING, ANY_METHOD_SUP, ANY_METHOD_TEST,
    ANY_METHOD_TO_EXPONENTIAL, ANY_METHOD_TO_FIXED, ANY_METHOD_TO_LOCALE_LOWER_CASE,
