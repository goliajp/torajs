...
use torajs_rc::{
    ...
    ANY_METHOD_FIND, ANY_METHOD_FIND_INDEX, ANY_METHOD_FOR_EACH, ANY_METHOD_GET, ANY_METHOD_HAS,
    ANY_METHOD_HAS_OWN_PROPERTY, ANY_METHOD_INCLUDES, ANY_METHOD_INDEX_OF, ANY_METHOD_JOIN,
    ANY_METHOD_KEYS, ANY_METHOD_LAST_INDEX_OF, ANY_METHOD_MAP, ANY_METHOD_MATCH, ANY_METHOD_POP,
    ...
    ANY_METHOD_SUP, ANY_METHOD_TEST, ANY_METHOD_TO_EXPONENTIAL, ANY_METHOD_TO_FIXED,
    ANY_METHOD_TO_LOCALE_STRING, ANY_METHOD_TO_LOWER_CASE, ANY_METHOD_TO_PRECISION,
