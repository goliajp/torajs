...
use torajs_rc::{
    ...
    ANY_METHOD_JOIN, ANY_METHOD_KEYS, ANY_METHOD_LAST_INDEX_OF, ANY_METHOD_MAP, ANY_METHOD_MATCH,
    ...
    ANY_METHOD_SET, ANY_METHOD_SHIFT, ANY_METHOD_SLICE, ANY_METHOD_SOME, ANY_METHOD_SPLICE,
    ANY_METHOD_SPLIT, ANY_METHOD_STARTS_WITH, ANY_METHOD_TEST, ANY_METHOD_TO_EXPONENTIAL,
    ANY_METHOD_TO_FIXED, ANY_METHOD_TO_LOCALE_STRING, ANY_METHOD_TO_LOWER_CASE,
    ANY_METHOD_TO_PRECISION, ANY_METHOD_TO_STRING, ANY_METHOD_TO_UPPER_CASE, ANY_METHOD_TRIM,
    ANY_METHOD_TRIM_END, ANY_METHOD_TRIM_START, ANY_METHOD_UNKNOWN, ANY_METHOD_UNSHIFT,
    ANY_METHOD_VALUE_OF, ANY_METHOD_VALUES,
};
