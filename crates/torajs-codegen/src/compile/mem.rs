...
use super::write_u32;
use super::{OP_SCRATCH_LHS, OP_SCRATCH_RHS};
use crate::enc::{add_imm, ldr_x_imm12, str_x_imm12};
use crate::reg::Gpr;
...
mod tests {
    ...
    use super::super::test_fixtures::{build_alloca_store_load_42, words_to_le_bytes};
    use crate::enc;
    use crate::reg::Gpr;
