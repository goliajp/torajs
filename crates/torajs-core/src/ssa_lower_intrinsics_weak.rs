...
pub(crate) struct WeakIds {
    ...
    pub weakmap_get_or_insert: FuncId,
    pub weakmap_get_or_insert_computed: FuncId,
...
pub(crate) fn declare(module: &mut Module, fn_table: &mut HashMap<String, FuncId>) -> WeakIds {
    WeakIds {
        ...
        weakmap_get_or_insert: declare_intrinsic(
            module,
            fn_table,
            "__torajs_weakmap_get_or_insert",
            &[Type::WeakMap, Type::Ptr, Type::Any],
            Type::Any,
        ),
        weakmap_get_or_insert_computed: declare_intrinsic(
            module,
            fn_table,
            "__torajs_weakmap_get_or_insert_computed",
            &[Type::WeakMap, Type::Ptr, Type::Any],
            Type::Any,
        ),
