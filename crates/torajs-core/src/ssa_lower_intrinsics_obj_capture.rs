...
pub(crate) struct ObjCaptureIds {
    ...
    pub obj_props_drop_slow: FuncId,
    pub obj_buffer_slow: FuncId,
    pub obj_unbuffer_slow: FuncId,
...
pub(crate) fn declare(
    ...
    ObjCaptureIds {
        ...
        obj_props_drop_slow: declare_intrinsic(
            module,
            fn_table,
            "__torajs_obj_props_drop_slow",
            &[Type::Ptr],
            Type::Void,
        ),
        obj_buffer_slow: declare_intrinsic(
            module,
            fn_table,
            "__torajs_obj_buffer_slow",
            &[Type::Ptr],
            Type::Void,
        ),
        obj_unbuffer_slow: declare_intrinsic(
            module,
            fn_table,
            "__torajs_obj_unbuffer_slow",
            &[Type::Ptr],
            Type::Void,
        ),
