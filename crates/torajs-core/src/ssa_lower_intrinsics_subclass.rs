...
pub(crate) struct ExoticSubclassIds {
    ...
    pub weakmap_subclass_alloc: FuncId,
    pub weakset_subclass_alloc: FuncId,
    pub date_subclass_alloc: FuncId,
...
pub(crate) fn declare(
    ...
    ExoticSubclassIds {
        ...
        weakmap_subclass_alloc: d(
            module,
            fn_table,
            "__torajs_weakmap_subclass_alloc",
            tag_only,
        ),
        weakset_subclass_alloc: d(
            module,
            fn_table,
            "__torajs_weakset_subclass_alloc",
            tag_only,
        ),
        date_subclass_alloc: d(module, fn_table, "__torajs_date_subclass_alloc", tag_only),
        weakmap_subclass_super: d(
            module,
            fn_table,
            "__torajs_weakmap_subclass_super",
            super_pair,
        ),
        weakset_subclass_super: d(
            module,
            fn_table,
        ...
        map_subclass_super: d(module, fn_table, "__torajs_map_subclass_super", super_pair),
        set_subclass_super: d(module, fn_table, "__torajs_set_subclass_super", super_pair),
