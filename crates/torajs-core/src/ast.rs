...
pub(crate) mod fnexpr_this_arrpush;
mod fnexpr_this_call_faces;
...
mod source_dunder_idents;
mod spread_callee_wrap;
mod spread_method_demote;
mod stmt;
mod stmt_class;
...
pub use delete_arr_widen::widen_deleted_array_bindings;
...
pub use early_label_errors::early_label_errors;
...
pub use prop_key_mangle::{mangle_key, unmangle_key};
...
pub use regex_result_props::analyze_regex_result_props;
...
pub use spread_method_demote::demote_dynamic_spread_method_calls;
