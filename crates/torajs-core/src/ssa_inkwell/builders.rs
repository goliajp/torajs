//! Primitive console-output IR builders.
//!
//! Three small fns that don't fit the Array<T> / split-iter / obj
//! families:
//!
...
//!
//! `define_obj_alloc` + `define_obj_drop_sized` live in the sibling
//! `obj_builders` module (split out 2026-05-26 Step 2 when the
//! inline-TLAB.push body pushed this file past the 500-LOC hard
//! limit; see [`super::obj_builders`]).
//!
