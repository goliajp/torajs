...
pub(crate) struct RegexIds {
    ...
    /// annexB §B.2.4.1 — in-place receiver re-init (rotation 447).
    pub regex_compile_inplace: FuncId,
    ...
    /// §22.1.3.19 step 5 over an `any` replaceValue — runtime
    /// IsCallable picks the functional vs ToString kernels.
    pub str_replace_any_repl: FuncId,
...
pub(crate) fn declare(module: &mut Module, fn_table: &mut HashMap<String, FuncId>) -> RegexIds {
    RegexIds {
        ...
        regex_compile_inplace: declare_intrinsic(
            module,
            fn_table,
            "__torajs_regex_compile_inplace",
            &[Type::RegExp, Type::Any, Type::Any],
            Type::RegExp,
        ),
        ...
        str_replace_any_repl: declare_intrinsic(
            module,
            fn_table,
            "__torajs_str_replace_any_repl",
            &[Type::Str, Type::Str, Type::Any, Type::I64],
            Type::Str,
        ),
